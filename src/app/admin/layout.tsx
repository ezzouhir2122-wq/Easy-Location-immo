    ...
    <div className="min-h-screen bg-[#07111f] text-white">
      <header className="border-b border-cyan-400/10 bg-[#0a1729]/90 px-6 py-4 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="flex items-center gap-3"><a href="/admin/demandes" className="hidden text-sm font-semibold text-slate-300 transition hover:text-cyan-200 sm:block">Demandes</a><a href="/admin/paiements" className="hidden text-sm font-semibold text-slate-300 transition hover:text-cyan-200 md:block">Paiements</a><a href="/admin/securite" className="hidden text-sm font-semibold text-slate-300 transition hover:text-cyan-200 lg:block">Sécurité</a><a href="/dashboard" className="rounded-xl border border-cyan-300/30 px-4 py-2 text-sm font-semibold text-cyan-100 transition hover:border-cyan-200 hover:bg-cyan-400/10">Espace client</a></div>
        </div>
      </header>
